...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="#">
        <img src="img/westhill_logo.png " className=' mx-lg-3 px-lg-3 logo' alt="" />
    </a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul className="">
            <li><a className="" href="#">ELSO</a></li>
            <li><a className="" href="#">CONTRACTOR</a></li>
            <li><a className="" href="#">CARRIER</a></li>
          </ul>
      </div>
    </div>

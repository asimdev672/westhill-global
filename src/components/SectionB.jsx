      ...
      <div className="container-fluid px-0 ">
        ...
        <div className="center-div">
          <h4 className="fw-bold mt-5 py-lg-4 text-center mb-0 ">
            Westhill is the first, and leading fully-digital managed repair
            solution connecting insurance carriers, homeowners, and
            highly-qualified reputable contractors.
          </h4>
        </div>
      </div>
      {/*------------- 2nd div-------------------------- */}
          ...
          <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-6  py-5  ">
              ...
              <p className="text-center mb-5 py-sm-3 px-3">
                Insurance Carriers have a unique opportunity to make the home
                repair process for policyholders a remarkable experience.
              </p>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-6    py-5 ">
